...
- **[asdf](/docs/resources/asdf)** - Universal version manager for multiple languages
...
- **[alias](/docs/resources/alias)** - Individual shell aliases
- **aliases** - Manage multiple aliases at once
- **[path](/docs/resources/path)** - PATH environment variable management
