...
<Steps>
  <Step>Run `codify apply` in the directory of the file. Open a new terminal and run the command `node -v` and
  `v20.9` should be returned. NodeJS is now installed and ready for use.</Step>
</Steps>
