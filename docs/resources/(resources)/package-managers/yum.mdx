...
- YUM is primarily for older Red Hat-based Linux distributions. For modern RHEL 8+, Fedora, Rocky Linux, and AlmaLinux systems, use the [dnf](/docs/resources/package-managers/dnf) resource instead, as DNF is the successor to YUM. For Debian-based systems, use the [apt](/docs/resources/package-managers/apt) resource.
